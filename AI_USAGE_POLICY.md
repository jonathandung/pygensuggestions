...
5. **Follow guidelines:** Comply with all rules in [CONTRIBUTING.md](https://github.com/jonathandung/pygensuggestions/CONTRIBUTING.md)
...
If you're unsure whether your use of AI tools complies with this policy, ask in the [discussions](https://github.com/jonathandung/pygensuggestions/discussions) or in the relevant issue or PR thread.
